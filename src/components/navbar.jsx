...
import navMenu from "./atroposComponet";
export const Navbar = () => {
  ...
  return (
    <nav className="mb-5 flex items-center justify-between py-6 px-6">
      <h1 className="text-textColor font-poppins text-nrm lg:pl-24  ">
        Halloween
      </h1>
      <div>
        {/* button  hamburger */}
        <button className="lg:hidden  md:hidden" onClick={handleToggle}>
          <img
            src="src\assets\menu-hamburger-svgrepo-com.svg"
            className="w-8 h-8"
          />
        </button>
        {/* navbar items  */}
        ...
        <ul
          ...
          } hidden md:flex lg:flex font-poppins text-textColor text-nrm`}>
          <li className="md:pr-10 lg:pr-20">
            <a href="">Home </a>
          </li>
          <li className="md:pr-10 lg:pr-20">
            <a href="">Events </a>
          ...
          <li className="md:pr-10 lg:pr-40">
            <a href="">contact us</a>
          </li>
        </ul>
      </div>
